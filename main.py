...
models = [
    ...
    {"script":os.path.join("models", "noisy_model_weighted_loss_lambda_80.py"),"apply_noise": True, "noise_std": 0.2, "noise_max": 0.3,},
    {"script":os.path.join("models", "noisy_model_weighted_loss_lambda_90.py"),"apply_noise": True, "noise_std": 0.2, "noise_max": 0.2},
    {"script":os.path.join("models", "noisy_model_weighted_loss_lambda_100.py"),"apply_noise": True, "noise_std": 0.1, "noise_max": 0.1},
    {"script":os.path.join("models", "noisy_model_weighted_loss_lambda_110.py"),"apply_noise": True, "noise_std": 0.1, "noise_max": 0.2},
    {"script":os.path.join("models", "noisy_model_weighted_loss_lambda_120.py"),"apply_noise": True, "noise_std": 0.1, "noise_max": 0.3},
    ...
    {"script":os.path.join("models", "noisy_modified_disc_weighted_loss_lambda_80.py"),"apply_noise": True, "noise_std": 0.1, "noise_max": 0.2, "conditional_disc": True},
    {"script":os.path.join("models", "noisy_modified_disc_weighted_loss_lambda_90.py"),"apply_noise": True, "noise_std": 0.2, "noise_max": 0.1, "conditional_disc": True},
    {"script":os.path.join("models", "noisy_modified_disc_weighted_loss_lambda_100.py"),"apply_noise": True, "noise_std": 0.1, "noise_max": 0.2, "conditional_disc": True},
